...
$pdf->Cell(12.9, 6, '', 1, 0, 'C');
$pdf->Cell(20.7, 6, '', 1, 0, 'C');
$pdf->Cell(18.5, 6, '', 1, 0, 'C');
$pdf->Cell(14.8, 6, '', 1, 0, 'C');
$pdf->Cell(17, 6, '', 1, 0, 'C');
$pdf->Cell(9.9, 6, '', 1, 0, 'C');
$pdf->Cell(13.5, 6, '', 1, 0, 'C');
$pdf->Cell(7, 6, '', 1, 0, 'C');
$pdf->Cell(6.9, 6, $checkmark1, 1, 0, 'C');
$pdf->Cell(6.8, 6, '', 1, 0, 'C');
$pdf->Cell(6.9, 6, '', 1, 0, 'C');
$pdf->Cell(7, 6, '', 1, 0, 'C');
$pdf->Cell(7.8, 6, '', 1, 0, 'C');
$pdf->Cell(6.8, 6, '', 1, 0, 'C');
$pdf->Cell(9.5, 6, '', 1, 0, 'C');
$pdf->Cell(4.6, 6, '', 1, 0, 'C');
$pdf->Cell(5.9, 6, '', 1, 0, 'C');
$pdf->Cell(5.8, 6, '', 1, 0, 'C');
$pdf->Cell(5.4, 6, '', 1, 0, 'C');
$pdf->Cell(8.2, 6, '', 1, 0, 'C');
$pdf->Cell(6.1, 6, '', 1, 0, 'C');
$pdf->Cell(7.6, 6, '', 1, 0, 'C');
$pdf->Cell(7.3, 6, '', 1, 0, 'C');
$pdf->Cell(7.3, 6, '', 1, 0, 'C');
$pdf->Cell(7.2, 6, '', 1, 0, 'C');
$pdf->Cell(24.4, 6, '', 1, 0, 'C');
$pdf->Cell(24.6, 6, '', 1, 0, 'C');
$pdf->ln(90);
