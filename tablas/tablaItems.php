...
$listaItems = listaItemsTabla($inicio,$fin,$busqueda);
...
while ($row = mysqli_fetch_array($listaItems)) {
    ...
    $estadoBtn = '<center><a class="btn btn-primary" style="z-index: 0;color:#fff" data-target="#modalNuevoProveedor" data-toggle="modal" onclick="buscarItem(\''.$row[5].'\')">M</a>&nbsp;&nbsp;</center>';
