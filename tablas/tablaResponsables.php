...
$listaItems = listaResponsablesCompleta($inicio,$fin,$busqueda);
...
while ($row = mysqli_fetch_array($listaItems)) {
    ...
    $estadoBtn = '<center><a class="btn btn-primary" style="z-index: 0;color:#fff" data-target="#modalNuevoProveedor" data-toggle="modal" onclick="buscarResponsable(\''.$row[4].'\')">M</a>&nbsp;&nbsp;<a class="btn btn-primary" style="z-index: 0;color:#fff" class="btn btn-info" onclick="eliminarItem(\''.$row[8].'\')">X</a></center>';
